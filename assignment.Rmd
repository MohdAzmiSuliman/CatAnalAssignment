...
```{r}
library(pacman)
p_load(readxl, Rmisc, tidyverse, summarytools, qwraps2, broom, knitr, gganimate, ordinal, brant, kableExtra)
...
demosumtable <- print(summary_table(anads1, demo_sum),
...
1. As compared to low bmi, normal BMI, overweight and obese associates with higehr category of HbA1c target
2. The odd ratio of 

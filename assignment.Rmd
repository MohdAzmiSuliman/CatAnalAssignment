...
Gender and total cholesterol level may have interaction because it was found that male had higher total cholesterol level as compared to female [`r t.test(anads1$tc ~ anads1$gender)`]

```{r}
anads1 %>% group_by(gender) %>% descr(wc)

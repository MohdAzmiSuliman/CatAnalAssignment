...
```{r}
clm_mod2 <- clm(HbA1C_T ~ bmic + tc + Dyslipidaemia + gender + Age, data = anads1)
summary(clm_mod2)
```
...
```{r}
clm_mod3 <- clm(HbA1C_T ~ tc + Dyslipidaemia + gender + Age, data = anads1)
summary(clm_mod3)
```
...
```{r}
clm_mod2ia <- clm(HbA1C_T ~ bmic + tc + Dyslipidaemia + gender + Age + gender:tc, data = anads1)
summary(clm_mod2ia)
anova(clm_mod2, clm_mod2ib)

clm_mod2ib <- clm(HbA1C_T ~ bmic + tc + Dyslipidaemia + gender + Age + gender:bmic, data = anads1)
summary(clm_mod2ib)
anova(clm_mod2, clm_mod2ib)
```
